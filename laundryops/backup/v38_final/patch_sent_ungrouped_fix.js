...
window.loadAdminSentList = async function() { console.log("Disabled patch_sent_ungrouped_fix"); };
    ...
    try {
        ...
        // 1. Supabase에서 발송 완료 내역 조회 (updated_at 제거)
        ...
        if (list && list.length > 0) {
            list.forEach(inv => {
                resultArr.push({
                    ...
                    lastSent: inv.created_at || inv.date, // created_at 만 사용
                    source: 'db'
                });
            });
        }
